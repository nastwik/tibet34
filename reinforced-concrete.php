				...
				<div class="col-lg-3">
                    ...
                    <div class="widget">
							...
							<ul class="categories">
								...
								<li><a href="reinforced-concrete.php" class="active-page">Бетон усиленный</a></li>
