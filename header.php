...
<body>
  ...
  <div class="search-box">
    <div class="inner">
      <form>
        <input type="search" placeholder="Пишите здесь для поиска">
  ...
  <aside class="side-widget open">
	<div class="inner">
			<div class="logo"> <a href="index.html"><img src="images/logo/logo.png" alt="Image"></a> </div>
  ...
  <nav class="navbar">
    <div class="container">
      <div class="logo"> <a href="index.php"><img src="images/logo/logo.png" alt="Image"></a> </div>
      <div class="site-menu">
        <ul>
          <li><a href="index.php">Главная</a></li>
          <li><a href="about.php">О компании</a></li>
