                ...
                <div class="col-lg-9">
                  <div class="main">
                     ...
                     <div class="main-details">
                      <div class="main-details-name">Бетон М-550П2 (В40)</div>
                  ...
                  <div class="characters">
                      <div class="characters__item">
                        ...
                        <div class="characters__right">
                          ...
                          <div class="characters__text">В 40</div>
                        </div>
                      </div>
                      <div class="characters__item">
                        <div class="characters__icon">
                          <img src="images/f.png" alt="Image">
                        </div>
                        <div class="characters__right">
                          <div class="characters__title decorate">Марка бетона</div>
                          <div class="characters__text">М-550</div>
                          </div>
                      </div>
                      <div class="characters__item">
                        <div class="characters__icon">
                          <img src="images/p-icon.png" alt="Image">
                        </div>
                        <div class="characters__right">
                          <div class="characters__title decorate">Подвижность</div>
                          <div class="characters__text">П П2</div>
                        </div>
                      </div>
                  </div>
</div>
  ...
  <div class="row no-gutters">
    ...
    <div class="swiper-wrapper">
      <div class="swiper-slide">
		  ...
		  <a href="">Бетон М-550П2 (В40)</a>
		</div>
      <div class="swiper-slide">
		  <figure><img src="images/concrete02.jpg" alt="Image"></figure>
		  <a href="">Бетон М-400П4 (В 30)</a>
		</div>
		<div class="swiper-slide">
		  <figure><img src="images/concrete02.jpg" alt="Image"></figure>
...
<section class="content-section no-spacing mb-100">
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-lg-6">
          <figure class="side-image"><img src="images/cars/mixer-blue.jpg" alt="Image"></figure>
        </div>
      </div>
    </div>
  </section>
